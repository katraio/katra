...
final class MeetingMessageReactionStoreController extends Controller
{
    public function __invoke(
        ...
        return new MeetingMessageResource($reactions->add($resolved, $user, $message, $validated['kind']));
    }
}
